...
import hero1 from "@/assets/006.jpg";
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        <motion.p
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="text-xs sm:text-sm tracking-[0.3em] uppercase text-white/70 mb-2"
        >
          Vagamon, Kerala
        </motion.p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link to="/projects">
            <button className="font-serif px-8 py-3 sm:py-4 bg-[#164e63] text-white tracking-widest transition-all duration-300 hover:bg-[#0f4c5c]">
              EXPLORE GLAMPS
            </button>
          </Link>
        </div>
