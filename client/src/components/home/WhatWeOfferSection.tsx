    ...
    <section className="py-24 bg-[#f5f5f5]">
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <div className="py-16">
          <Link
            to="/facilities"
            className="font-serif inline-block px-8 py-3 border border-[#164e63] text-[#164e63] uppercase tracking-[0.2em] text-sm font-medium hover:bg-[#164e63] hover:text-white transition-all duration-300"
          >
            View All Activities
          </Link>
        </div>
