    ...
    <section className="bg-[#f5f5f3] py-20 px-6">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <p className="text-gray-700 text-sm sm:text-base leading-relaxed mb-6">
          Pendora Glamps in Vagamon offers a luxurious escape blending modern
      ...
      <div className="max-w-7xl mx-auto mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 text-sm leading-relaxed">
            Experience a unique stay in a beautifully designed dome nestled in
            the hills, offering breathtaking night views and a peaceful
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 text-sm leading-relaxed">
            Relax on a spacious elevated deck with stunning panoramic views of
            the surrounding greenery, creating the perfect spot to unwind and
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 text-sm leading-relaxed">
            Take a refreshing walk along scenic pathways that wind through lush
            tea plantations, offering guests a calm and rejuvenating
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 text-sm leading-relaxed">
            Enjoy thoughtfully designed facilities set within picturesque
            landscapes, combining modern comfort with the natural beauty of
