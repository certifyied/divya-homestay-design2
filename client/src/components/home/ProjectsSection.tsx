...
import projectBlack from "@/assets/016.jpg";
import projectWood from "@/assets/DSC09418.jpg";
      ...
      <div className="container-wide">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          >
            ...
            <Link
              to="/projects"
              className="font-serif inline-flex w-fit items-center gap-2 border border-white text-white px-8 py-3 uppercase tracking-[0.25em] text-sm hover:bg-white hover:text-[#164e63] transition-all duration-300"
            >
              View All
              <ArrowUpRight className="w-4 h-4" />
            </Link>
