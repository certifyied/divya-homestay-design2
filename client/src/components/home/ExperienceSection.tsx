...
import img2 from "@/assets/023.jpg";
    ...
    <section className="py-20 bg-gray-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex justify-center mt-14">
          <Link
            to="/experience"
            className="font-serif flex items-center gap-2 px-8 py-3 border border-[#164e63] text-[#164e63] tracking-wide transition-all duration-300 hover:bg-[#164e63] hover:text-white"
          >
