...
import blog1 from "@/assets/002.jpg";
import blog2 from "@/assets/ABC04057 (1) (1) (1).jpg";
import blog3 from "@/assets/021.jpg";
import blog4 from "@/assets/023.jpg";
import blog5 from "@/assets/004.jpg";
import blog6 from "@/assets/ABC04163 (1).jpg";
import blog7 from "@/assets/022.jpg";
import blog8 from "@/assets/009 (1).jpg";

const blogs = [
  {
    id: 1,
    title: "Unforgettable Experiences to Try in Vagamon",
  ...
  {
    id: 5,
    title: "Experience the Best of Vagamon Like Never Before",
  ...
  {
  id: 7,
  title: "Indulge in a Luxury Jacuzzi Experience in Vagamon",
  desc: "Elevate your stay with a private jacuzzi overlooking Vagamon’s breathtaking landscapes. Soak in warm waters, enjoy cool mountain air, and experience unmatched comfort in the heart of nature.",
  img: blog7,
},
  {
    id: 8,
    title: "Hidden Gems in Vagamon You Shouldn’t Miss",
    desc: "Explore lesser-known spots in Vagamon including secret viewpoints, quiet meadows, and untouched natural beauty away from the crowds.",
    img: blog8,
  }
];
          ...
          <div className="absolute inset-0 flex items-center justify-center text-center px-6">
            <div className="text-white max-w-3xl">
              ...
              <p className="text-lg md:text-xl text-gray-200">
                Designed to inspire your journey into nature and comfort.
              </p>
            </div>
          </div>
        </section>
